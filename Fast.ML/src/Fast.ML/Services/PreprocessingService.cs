...
using PreprocessingServiceClient = Fast.ML.Preprocessor.Grpc.PreprocessingService.PreprocessingServiceClient;
...
public class PreprocessingService : IPreprocessingService
{
    ...
    public async Task<string> PreprocessDatasetAsync(
        ...
        (await _client.PreprocessDatasetAsync(request, cancellationToken: cancellationToken)).Message;
}