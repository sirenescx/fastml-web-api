...
public class UserService : IUserService
{
    ...
    public async Task<UserIdResponse> GetUserIdAsync(UserIdRequest request, CancellationToken token)
    {
        var userId =
            await _repository.GetUserIdAsync(request.Email) ??
            await _repository.CreateUserAsync(request.Email, request.FirstName, request.LastName);
    ...
    public async Task<UserTaskResponse> PostUserTaskAsync(UserTaskRequest request, CancellationToken token)
    {
    ...
    public async Task<UserTasksResponse> GetUserTasksAsync(UserTasksRequest request, CancellationToken token)
    {
